package com.comcast.crm.orgtest.Pom.TestNGBAseClass.ListnerClass;
...
import com.comcast.crm.listenerutility.ListImpClass2;
...
@Listeners(com.comcast.crm.listenerutility.ListImpClass2.class)
public class CreateOrganizationTest extends BaseClass{
	...
	//	ListImpClass2.test.log(Status.INFO,"read Data Froam Excel");
		UtilityClassObject.getTest().log(Status.INFO,"read Data Froam Excel");
	...
	//	ListImpClass2.test.log(Status.INFO,"Navigate to org Page");
        ...
        //   ListImpClass2.test.log(Status.INFO,"Navigate to create org Page");
	   ...
	   //  ListImpClass2.test.log(Status.INFO," create a new org Page");
	   ...
	   //  ListImpClass2.test.log(Status.INFO, orgName+"====> create a new org ");
